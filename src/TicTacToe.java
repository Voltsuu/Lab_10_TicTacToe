...
public class TicTacToe {
    ...
    public static void main(String[] args) {
        ...
        while (!gameDone) {
            ...
            doneRound = false;
            while (!done) {
                temp = InputHelper.getNonZeroLengthString(scan, "Player 1, choose Xs or Os.");
            ...
            while (!doneRound) {
                ...
                donePlayerTwo = false;
                while (!donePlayerOne){
                    playerOneMoveRow = InputHelper.getRangedInt(scan, "Pick a row for your move (Player 1)", 1, 3);
                    playerOneMoveCol = InputHelper.getRangedInt(scan, "Pick a column for your move (Player 1)", 1, 3);
                ...
                while (!donePlayerTwo){
                    playerTwoMoveRow = InputHelper.getRangedInt(scan, "Pick a row for your move (Player 2)", 1, 3);
                    playerTwoMoveCol = InputHelper.getRangedInt(scan, "Pick a column for your move (Player 2)", 1, 3);
            ...
            gameDone = InputHelper.getYNConfirm(scan, "Play again?(Y/N)");
        }
    }
